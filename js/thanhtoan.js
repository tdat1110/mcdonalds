...
let products = [
    {
        id: randomId(),
        name: 'Phần ăn EVM 6 miếng gà McNuggets',
        description:
            '',
        price: 79000,
        image:
            'https://www.mcdonalds.vn/uploads/2018/food/evm/EVM_03_6pcs_chicken_mcnuggets_0.png',
        count: 1,
    },  
];
...
function renderUI(arr) {
    ...
    countEle.innerText = `${updateTotalItem(arr)} sản phẩm trong giỏ hàng`;
